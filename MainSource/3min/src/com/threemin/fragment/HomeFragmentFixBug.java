...
//            changeIfNoItem();
    ...
    public void onSwichCategory(CategoryModel categoryModel) {
        ...
        new GetProductTaks(HomeFragmentFixBug.this).execute(STEP_INIT);
    }
...
//                new GetProductTaks(HomeFragmentFixBug.this).execute(HomeFragment.STEP_REFRESH);
                new GetProductTaks(HomeFragmentFixBug.this).execute(HomeFragment.STEP_REFRESH);
            }
        });
...
//                    new GetProductTaks(HomeFragmentFixBug.this).execute(HomeFragment.STEP_ADDMORE);
                    new GetProductTaks(HomeFragmentFixBug.this).execute(HomeFragment.STEP_ADDMORE);
                }
